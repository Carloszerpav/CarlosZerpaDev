...
def adobe_service_buttons() -> list[dict]:
    options = [
        (
            "Integraciones",
            "link",
            "Conectamos Adobe con tus herramientas y sistemas.",
