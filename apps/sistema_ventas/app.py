...
if os.environ.get('RAILWAY_ENVIRONMENT') or os.environ.get('RAILWAY_ENVIRONMENT_NAME') or os.environ.get('VERCEL'):
...
if os.environ.get('VERCEL'):
    DATABASE_URL = os.environ.get('DATABASE_URL', 'sqlite:////tmp/ventas.db')
else:
...
def login_demo():
    """Acceso de demostración para usar el sistema desde el portfolio."""
    user = User(id='demo', email='demo@portfolio.local', name='Demo', picture='')
    session['user'] = {
        'id': 'demo',
